...
var canvas = {
  ...
  createCanvasDiv : function(p){
    var oDrag = document.body.appendChild(document.createElement("div"));
    oDrag.id = 'drag';
    var html = '\
    <div class="title">\
        <h2>这是一个可以拖动的窗口</h2>\
    ...
    oDrag.style.left = p.x + "px";
    oDrag.style.top = p.y + "px";
  },
  run : function(p){
    this.createCanvasDiv(p);
  }
}